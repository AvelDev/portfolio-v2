function Card() {
  return (
    <div className="border-2 border-primary rounded-md p-4">
      <h3 className="text-xl font-bold text-center">Vue Crash</h3>
      <p>Strona do sprawdzania dostępnych ofert pracy</p>
      <img />
      <a
        className="hover:text-primary-500 transition duration-200 ease-in-out"
        href="https://github.com/AvelDev/vue-crash.git"
      >
        Kod źródłowy
      </a>
      <p className="font-semibold">Użyte technologie:</p>
      <div className="mt-1 flex justify-start h-6">
